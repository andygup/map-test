import {H as H$1,ah as y$1}from'./main-Y4UOJ3OT.js';var S=()=>y$1.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder"),h=class{constructor(){this._includedModules=new Map;}include(e,n){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,n),e(this.builder,n));}},v=class extends h{constructor(){super(...arguments),this.vertex=new m,this.fragment=new m,this.attributes=new b,this.varyings=new f,this.outputs=new F;}get attributeNames(){return this.attributes.names}get builder(){return this}generate(e,n=false){let t=this.attributes.generateSource(e),i=this.varyings.generateSource(e),s=e==="vertex"?this.vertex:this.fragment,a=s.uniforms.generateSource(),o=s.code.generateSource(),u=s.main.generateSource(n),T=this.debugName?`// ${this.debugName}
