import{a as h}from"./chunk-MUQQ6GJS.js";import{a}from"./chunk-MI7CDTQL.js";import{a as n}from"./chunk-6WLT4IGN.js";import{a as p}from"./chunk-LI2AJFVU.js";import{a as d}from"./chunk-SYFPWUTB.js";import{a as s}from"./chunk-SNAZ42PQ.js";import{a as r,b as i}from"./chunk-YSASWMAG.js";function f(t){t.uniforms.add(new a("mainLightDirection",e=>e.lighting.mainLight.direction))}function m(t){t.uniforms.add(new a("mainLightIntensity",e=>e.lighting.mainLight.intensity))}function v(t){f(t),m(t),t.code.add(r`vec3 applyShading(vec3 shadingNormal, float shadow) {
float dotVal = clamp(dot(shadingNormal, mainLightDirection), 0.0, 1.0);
return mainLightIntensity * ((1.0 - shadow) * dotVal);
}`)}function M(t,e){let c=t.fragment;c.include(h),c.uniforms.add(new s("nearFar",o=>o.camera.nearFar),new p("depthMap",o=>o.depth?.attachment),new n("proj",o=>o.camera.projectionMatrix),new d("invResolutionHeight",o=>1/o.camera.height),new n("reprojectionMatrix",o=>o.reprojection.matrix)).code.add(r`
  ...
  vec3 screenSpaceIntersectionWithLimits(
    ...
    for(int stepIndex = 0; stepIndex < rayMarchMaxStepsInt - 1; ++stepIndex) {
      ...
      ${i(!e.clampRayToScreen,`if (projectedPosition.x <= 0.0  || projectedPosition.x >= 1.0) {
        return vec3(projectedPosition, 0.0);
      }`)}
      ...
      ${i(e.clampRayToScreen,"projectedPosition = clamp(projectedPosition, vec2(0.0), vec2(0.999));")}
    }
    return vec3(projectedPosition, 0.0);
  }
  ...
  vec3 screenSpaceIntersection(vec3 rayDirection, vec3 startPosition, vec3 viewDirection, vec3 normal, float rayStepOffset) {
    return screenSpaceIntersectionWithLimits(
      ...
      normal,
      rayStepOffset,
      ${r.float(e.rayMarchMaxReach)},
      ${r.float(e.rayMarchMaxSteps)}
    );
  }
  `)}export{f as a,m as b,v as c,M as d};
