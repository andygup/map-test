import{CD as e,Jy as t,Rl as n,Ry as r,Xf as i,Z as a,y_ as o}from"./index-BN8X5Ryz.js";import{s}from"./Emissions.glsl-C_Yvv-sZ.js";import{n as c,t as l}from"./glsl-BMw-Ib6r.js";import{t as u}from"./FloatPassUniform-CSAt82xV.js";import{t as d}from"./Texture2DPassUniform-DFWoDpEL.js";import{n as f,o as p,s as m}from"./MaterialUtil-CcE5uVnF.js";import{t as h}from"./Float3BindUniform-BDFedz_d.js";import{t as g}from"./Matrix4PassUniform-CDJEQqiQ.js";import{t as _}from"./IntegerPassUniform-CdQB44QJ.js";import{t as v}from"./Slice.glsl-DU3Ivhcc.js";import{t as y}from"./ObjectAndLayerIdColor.glsl-BHzrt-xI.js";import{a as b,n as x,r as S,t as C}from"./VisualVariables.glsl-1DqsizMu.js";import{a as w,i as T,n as E,t as D}from"./AlphaCutoff-WIqqBGOV.js";import{n as O,r as k}from"./View.glsl-CPcmVaet.js";import{a as A,i as j,n as M,o as N,r as P,t as F}from"./Transform.glsl-2U1BxklA.js";import{s as I}from"./SnowCover.glsl-DvDl-UAS.js";function L(t,n){switch(t.fragment.code.add(c`vec3 screenDerivativeNormal(vec3 positionView) {
return normalize(cross(dFdx(positionView), dFdy(positionView)));
}`),n.normalType){case 1:t.attributes.add(`normalCompressed`,`vec2`),t.vertex.code.add(c`vec3 decompressNormal(vec2 normal) {
float z = 1.0 - abs(normal.x) - abs(normal.y);
return vec3(normal + sign(normal) * min(z, 0.0), z);
}
vec3 normalModel() {
return decompressNormal(normalCompressed);
}`);break;case 0:t.attributes.add(`normal`,`vec3`),t.vertex.code.add(c`vec3 normalModel() {
return normal;
}`);break;default:e(n.normalType);case 2:case 3:}}function R(t,n){switch(n.normalType){case 0:case 1:t.include(L,n),t.varyings.add(`vNormalWorld`,`vec3`),t.varyings.add(`vNormalView`,`vec3`),t.vertex.uniforms.add(new A(`transformNormalGlobalFromModel`,e=>e.transformNormalGlobalFromModel),new w(`transformNormalViewFromGlobal`,e=>e.transformNormalViewFromGlobal)).code.add(c`void forwardNormal() {
vNormalWorld = transformNormalGlobalFromModel * normalModel();
vNormalView = transformNormalViewFromGlobal * vNormalWorld;
}`);break;case 2:t.vertex.code.add(c`void forwardNormal() {}`);break;default:e(n.normalType);case 3:}}var z=class extends P{constructor(){super(...arguments),this.transformNormalViewFromGlobal=r()}},B=class extends j{constructor(){super(...arguments),this.transformNormalGlobalFromModel=r(),this.toMapSpace=a()}};function V(e){e.vertex.code.add(c`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return color;
}`)}var U=r();function W(e,r){let{hasModelTransformation:a,instancedDoublePrecision:o,instanced:s,output:l,hasVertexTangents:u}=r;a&&(e.vertex.uniforms.add(new g(`model`,e=>e.modelTransformation??i)),e.vertex.uniforms.add(new w(`normalLocalOriginFromModel`,e=>(t(U,e.modelTransformation??i),U)))),s&&o&&(e.attributes.add(`instanceModelOriginHi`,`vec3`),e.attributes.add(`instanceModelOriginLo`,`vec3`),e.attributes.add(`instanceModel`,`mat3`),e.attributes.add(`instanceModelNormal`,`mat3`));let d=e.vertex;o&&(d.include(N,r),d.uniforms.add(new h(`viewOriginHi`,e=>p(n(G,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),G)),new h(`viewOriginLo`,e=>m(n(G,e.camera.viewInverseTransposeMatrix[3],e.camera.viewInverseTransposeMatrix[7],e.camera.viewInverseTransposeMatrix[11]),G)))),d.code.add(c`
    ...
    }`)}var G=o();function K(e,t){e.varyings.add(`colorMixMode`,`int`),e.varyings.add(`opacityMixMode`,`int`),e.vertex.uniforms.add(new _(`symbolColorMixMode`,e=>f[e.colorMixMode])),t.hasSymbolColors?(e.vertex.include(b),e.vertex.include(S),e.vertex.include(x),e.attributes.add(`symbolColor`,`vec4`),e.vertex.code.add(c`
