import{n as e,t}from"./glsl-B__sVAcg.js";import{t as n}from"./Texture2DPassUniform-wY08hxIn.js";import{t as r}from"./ShaderBuilder-NkkCCxyc.js";import{t as i}from"./Float2BindUniform-COpkFEGz.js";import{t as a}from"./Float4BindUniform-DtHi0dnJ.js";import{t as o}from"./Float4PassUniform-CYWbrPzx.js";import{t as s}from"./FloatBindUniform-BPgZfINH.js";import{t as c}from"./Matrix4BindUniform-DNS5lGEU.js";import{t as l}from"./Slice.glsl-ILtGSCz4.js";import{i as u,n as d}from"./AlphaCutoff-qYsC5qb0.js";import{i as f,n as p,r as m}from"./View.glsl-DOc5qj3l.js";import{a as h,i as g,n as _,o as v,r as y,s as b,t as x}from"./MarkerSizing.glsl-BphOmtUd.js";import{t as S}from"./TerrainDepthTest.glsl-8QLA4mH-.js";import{t as C}from"./OutputColorHighlightOLID.glsl-DrcS4MFv.js";function w(g){let _=new r,{space:y,anchor:w,hasTip:T,hasScreenSizePerspective:E}=g,D=y===2,O=y===1;_.include(b,g),_.include(x,g),_.include(S,g);let{vertex:k,fragment:A,varyings:j}=_;p(k,g),_.attributes.add(`position`,`vec3`),_.attributes.add(`previousDelta`,`vec4`),_.attributes.add(`uv0`,`vec2`),j.add(`vColor`,`vec4`),j.add(`vpos`,`vec3`,{invariant:!0}),j.add(`vUV`,`vec2`),j.add(`vSize`,`float`),T&&j.add(`vLineWidth`,`float`),k.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
