import{n as e,t}from"./glsl-BMw-Ib6r.js";import{t as n}from"./ShaderBuilder-BLOqjpgt.js";import{t as r}from"./Float4PassUniform-C4TO8dd0.js";import{t as i}from"./FloatBindUniform-CXY5KrrB.js";import{t as a}from"./Slice.glsl-DU3Ivhcc.js";import{t as o}from"./ObjectAndLayerIdColor.glsl-BHzrt-xI.js";import{t as s}from"./VisualVariables.glsl-1DqsizMu.js";import{i as c}from"./AlphaCutoff-WIqqBGOV.js";import{n as l,t as u}from"./View.glsl-CPcmVaet.js";import{t as d}from"./TerrainDepthTest.glsl-D7e23Ppb.js";import{t as f}from"./OutputColorHighlightOLID.glsl-CoP020fC.js";import{t as p}from"./Transform.glsl-2U1BxklA.js";import{t as m}from"./VertexColor.glsl-_MhPfHih.js";var h=.70710678118,g=h,_=.08715574274,v=10,y=1;function b(b){let S=new n,{vertex:C,fragment:w,attributes:T,varyings:E}=S,D=b.output===8;l(C,b),S.include(p),S.include(m,b),S.include(s,b),S.include(o,b),S.fragment.include(a,b),S.include(f,b),S.include(d,b),b.draped?C.uniforms.add(new i(`worldToScreenRatio`,e=>1/e.screenToPCSRatio)):T.add(`boundingRect`,`mat3`),T.add(`position`,`vec3`),T.add(`uvMapSpace`,`vec4`),b.hasVVColor&&T.add(`colorFeatureAttribute`,`float`),b.hasVertexColors||E.add(`vColor`,`vec4`),E.add(`vpos`,`vec3`,{invariant:!0}),E.add(`vuv`,`vec2`),C.uniforms.add(new r(`uColor`,e=>e.color));let O=b.style===3||b.style===4||b.style===5;return O&&C.code.add(e`
      const mat2 rotate45 = mat2(${e.float(h)}, ${e.float(-g)},
                                 ${e.float(g)}, ${e.float(h)});
    `),b.draped||(u(C,b),C.uniforms.add(new i(`worldToScreenPerDistanceRatio`,e=>1/e.camera.perScreenPixelRatio)),C.code.add(e`vec3 projectPointToLineSegment(vec3 center, vec3 halfVector, vec3 point) {
...
return rayOrigin + t * rayDir;
  ...
  `),w.include(c),b.draped&&w.uniforms.add(new i(`texelSize`,e=>1/e.camera.pixelRatio)),D||(w.code.add(e`
