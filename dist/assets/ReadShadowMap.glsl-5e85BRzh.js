import{Ol as e,Z as t,c_ as n,mt as r}from"./index-CzMixifc.js";import{l as i}from"./Emissions.glsl-nadaueeL.js";import{n as a,t as o}from"./glsl-B__sVAcg.js";import{t as s}from"./Uniform-CfHWJqSg.js";import{t as c}from"./Float4BindUniform-DtHi0dnJ.js";import{t as l}from"./Float3BindUniform-DnRIK6cJ.js";import{t as u}from"./FloatBindUniform-BPgZfINH.js";import{r as d}from"./AlphaCutoff-qYsC5qb0.js";import{t as f}from"./PiUtils.glsl-D-ndpb0M.js";import{s as p}from"./Transform.glsl-DMKMztkJ.js";var m=3e5,h=5e5;function g(t,n){let i=n.lightingSphericalHarmonicsOrder===void 0?2:n.lightingSphericalHarmonicsOrder;i===0?(t.uniforms.add(new l(`lightingAmbientSH0`,({lighting:t})=>e(_,t.sh.r[0],t.sh.g[0],t.sh.b[0]))),t.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===1?(t.uniforms.add(new c(`lightingAmbientSH_R`,({lighting:e})=>r(v,e.sh.r[0],e.sh.r[1],e.sh.r[2],e.sh.r[3])),new c(`lightingAmbientSH_G`,({lighting:e})=>r(v,e.sh.g[0],e.sh.g[1],e.sh.g[2],e.sh.g[3])),new c(`lightingAmbientSH_B`,({lighting:e})=>r(v,e.sh.b[0],e.sh.b[1],e.sh.b[2],e.sh.b[3]))),t.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`),n.pbrMode!==1&&n.pbrMode!==2||t.code.add(a`const vec3 skyTransmittance = vec3(0.9, 0.9, 1.0);
vec3 calculateAmbientRadiance(float ambientOcclusion)
{
vec3 ambientLight = 1.2 * (0.282095 * lightingAmbientSH0) - 0.2;
return ambientLight *= (1.0 - ambientOcclusion) * skyTransmittance;
}`))}var _=n(),v=t();function y(e){e.uniforms.add(new l(`mainLightDirection`,e=>e.lighting.mainLight.direction))}function b(e){e.uniforms.add(new l(`mainLightIntensity`,e=>e.lighting.mainLight.intensity))}function x(e){y(e),b(e),e.code.add(a`vec3 applyShading(vec3 shadingNormal, float shadow) {
