import{n as e,t}from"./glsl-B__sVAcg.js";import{t as n}from"./ShaderBuilder-NkkCCxyc.js";import{t as r}from"./Float4PassUniform-CYWbrPzx.js";import{t as i}from"./FloatBindUniform-BPgZfINH.js";import{t as a}from"./Slice.glsl-ILtGSCz4.js";import{t as o}from"./ObjectAndLayerIdColor.glsl-DLOlMhcf.js";import{t as s}from"./VisualVariables.glsl-0raoMJkY.js";import{i as c}from"./AlphaCutoff-qYsC5qb0.js";import{n as l,t as u}from"./View.glsl-DOc5qj3l.js";import{t as d}from"./TerrainDepthTest.glsl-8QLA4mH-.js";import{t as f}from"./OutputColorHighlightOLID.glsl-DrcS4MFv.js";import{t as p}from"./Transform.glsl-BzRx33WP.js";import{t as m}from"./VertexColor.glsl-D6K20lwp.js";var h=.70710678118,g=h,_=.08715574274,v=10,y=1;function b(b){let S=new n,{vertex:C,fragment:w,attributes:T,varyings:E}=S,D=b.output===8;l(C,b),S.include(p),S.include(m,b),S.include(s,b),S.include(o,b),S.fragment.include(a,b),S.include(f,b),S.include(d,b),b.draped?C.uniforms.add(new i(`worldToScreenRatio`,e=>1/e.screenToPCSRatio)):T.add(`boundingRect`,`mat3`),T.add(`position`,`vec3`),T.add(`uvMapSpace`,`vec4`),b.hasVVColor&&T.add(`colorFeatureAttribute`,`float`),b.hasVertexColors||E.add(`vColor`,`vec4`),E.add(`vpos`,`vec3`,{invariant:!0}),E.add(`vuv`,`vec2`),C.uniforms.add(new r(`uColor`,e=>e.color));let O=b.style===3||b.style===4||b.style===5;return O&&C.code.add(e`
