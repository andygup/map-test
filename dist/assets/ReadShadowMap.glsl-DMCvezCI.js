import{Rl as e,Z as t,mt as n,y_ as r}from"./index-BN8X5Ryz.js";import{l as i}from"./Emissions.glsl-C_Yvv-sZ.js";import{n as a,t as o}from"./glsl-BMw-Ib6r.js";import{t as s}from"./Uniform-C_fuiTP5.js";import{t as c}from"./Float4BindUniform-DpoBnM9l.js";import{t as l}from"./Float3BindUniform-BDFedz_d.js";import{t as u}from"./FloatBindUniform-CXY5KrrB.js";import{r as d}from"./AlphaCutoff-WIqqBGOV.js";import{t as f}from"./PiUtils.glsl-IDKkXUQy.js";import{s as p}from"./Transform.glsl-2U1BxklA.js";var m=3e5,h=5e5;function g(t,r){let i=r.lightingSphericalHarmonicsOrder===void 0?2:r.lightingSphericalHarmonicsOrder;i===0?(t.uniforms.add(new l(`lightingAmbientSH0`,({lighting:t})=>e(_,t.sh.r[0],t.sh.g[0],t.sh.b[0]))),t.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):i===1?(t.uniforms.add(new c(`lightingAmbientSH_R`,({lighting:e})=>n(v,e.sh.r[0],e.sh.r[1],e.sh.r[2],e.sh.r[3])),new c(`lightingAmbientSH_G`,({lighting:e})=>n(v,e.sh.g[0],e.sh.g[1],e.sh.g[2],e.sh.g[3])),new c(`lightingAmbientSH_B`,({lighting:e})=>n(v,e.sh.b[0],e.sh.b[1],e.sh.b[2],e.sh.b[3]))),t.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`),r.pbrMode!==1&&r.pbrMode!==2||t.code.add(a`const vec3 skyTransmittance = vec3(0.9, 0.9, 1.0);
vec3 calculateAmbientRadiance(float ambientOcclusion)
{
vec3 ambientLight = 1.2 * (0.282095 * lightingAmbientSH0) - 0.2;
return ambientLight *= (1.0 - ambientOcclusion) * skyTransmittance;
}`))}var _=r(),v=t();function y(e){e.uniforms.add(new l(`mainLightDirection`,e=>e.lighting.mainLight.direction))}function b(e){e.uniforms.add(new l(`mainLightIntensity`,e=>e.lighting.mainLight.intensity))}function x(e){y(e),b(e),e.code.add(a`vec3 applyShading(vec3 shadingNormal, float shadow) {
