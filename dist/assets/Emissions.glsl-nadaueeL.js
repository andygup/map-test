import{_T as e,oh as t,uD as n,zw as r}from"./index-CzMixifc.js";import{n as i,t as a}from"./glsl-B__sVAcg.js";import{t as o}from"./Uniform-CfHWJqSg.js";import{t as s}from"./Float3DrawUniform-UWnIK6YY.js";import{t as c}from"./Float3PassUniform-BIrLVK7_.js";import{t as l}from"./FloatPassUniform-D-_T45xB.js";import{t as u}from"./Texture2DDrawUniform-CV_1kucp.js";import{t as d}from"./Texture2DPassUniform-wY08hxIn.js";import{t as f}from"./NoParameters-B66z9IwQ.js";function p(e){return e===3||e===4||e===5||e===6||e===7}function m(e){return b(e)||e===2}function h(e){return e===8||e===9}function g(e){return _(e)||h(e)}function _(e){return e===0}function v(e){return _(e)||e===9}function y(e){return _(e)||h(e)}function b(e){return y(e)||x(e)}function x(e){return e===1}function S(e){return x(e)||p(e)}function C(e,t){switch(t.textureCoordinateType){case 1:e.attributes.add(`uv0`,`vec2`),e.varyings.add(`vuv0`,`vec2`),e.vertex.code.add(i`void forwardTextureCoordinates() { vuv0 = uv0; }`);return;case 2:e.attributes.add(`uv0`,`vec2`),e.attributes.add(`uvRegion`,`vec4`),e.varyings.add(`vuv0`,`vec2`),e.varyings.add(`vuvRegion`,`vec4`),e.vertex.code.add(i`void forwardTextureCoordinates() {
vuv0 = uv0;
vuvRegion = uvRegion;
}`);return;default:n(t.textureCoordinateType);case 0:e.vertex.code.add(i`void forwardTextureCoordinates() {}`);return;case 3:return}}function w(e){e.fragment.code.add(i`vec4 textureAtlasLookup(sampler2D tex, vec2 textureCoordinates, vec4 atlasRegion) {
