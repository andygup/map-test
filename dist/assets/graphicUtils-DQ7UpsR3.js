import{s as y,f as P,o as b}from"./DefaultBufferWriter-BFyQkuVz.js";import{d as S,f as z,e as g,o as u,p as C,w as D,s as V,a as A}from"./Geometry-C-mMk4A4.js";import{e2 as v,i2 as s,lA as R,lB as $,dz as m,lC as j,lD as H,aS as M,lE as T,lF as U,lG as G,by as E,lH as F,lI as N,lJ as I,lK as k,bE as Y,cC as L,lL as Z,lM as q,lN as B}from"./index-CC72Q5ax.js";import{c as h}from"./GeometryUtil-B3ewm9Ov.js";import{u as J}from"./meshVertexSpaceUtils-CnmEbj7h.js";import{o as K,x as Q}from"./hydratedFeatures-BnjDXNd2.js";const W=.5;function ce(e,t){e.include(y),e.attributes.add(v.POSITION,"vec3"),e.attributes.add(v.NORMAL,"vec3"),e.attributes.add(v.CENTEROFFSETANDDISTANCE,"vec4");const o=e.vertex;S(o,t),z(o,t),o.uniforms.add(new g("viewport",(i,n)=>n.camera.fullViewport),new u("polygonOffset",i=>i.shaderPolygonOffset),new u("cameraGroundRelative",(i,n)=>n.camera.aboveGround?1:-1)),t.hasVerticalOffset&&P(o),o.constants.add("smallOffsetAngle","float",.984807753012208),o.code.add(s`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
