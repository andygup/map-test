import{n as e,t}from"./glsl-B__sVAcg.js";import{t as n}from"./Texture2DPassUniform-wY08hxIn.js";import{t as r}from"./ShaderBuilder-Dbc4jYz7.js";import{t as i}from"./Float2BindUniform-COpkFEGz.js";import{t as a}from"./Float4BindUniform-DtHi0dnJ.js";import{t as o}from"./Float4PassUniform-CYWbrPzx.js";import{t as s}from"./FloatBindUniform-BPgZfINH.js";import{t as c}from"./Matrix4BindUniform-DNS5lGEU.js";import{t as l}from"./Slice.glsl-A8bL0Rkn.js";import{i as u,n as d}from"./AlphaCutoff-qYsC5qb0.js";import{i as f,n as p,r as m}from"./View.glsl-D5eT11ZQ.js";import{a as h,i as g,n as _,o as v,r as y,s as b,t as x}from"./MarkerSizing.glsl-CtCvR4o9.js";import{t as S}from"./TerrainDepthTest.glsl-BUpx6Cvv.js";import{t as C}from"./OutputColorHighlightOLID.glsl-B38t8Aex.js";function w(g){let _=new r,{space:y,anchor:w,hasTip:T,hasScreenSizePerspective:E}=g,D=y===2,O=y===1;_.include(b,g),_.include(x,g),_.include(S,g);let{vertex:k,fragment:A,varyings:j}=_;p(k,g),_.attributes.add(`position`,`vec3`),_.attributes.add(`previousDelta`,`vec4`),_.attributes.add(`uv0`,`vec2`),j.add(`vColor`,`vec4`),j.add(`vpos`,`vec3`,{invariant:!0}),j.add(`vUV`,`vec2`),j.add(`vSize`,`float`),T&&j.add(`vLineWidth`,`float`),k.uniforms.add(new i(`nearFar`,({camera:e})=>e.nearFar),new a(`viewport`,({camera:e})=>e.fullViewport)).code.add(e`vec4 projectAndScale(vec4 pos) {
...
}`),D?(_.attributes.add(`normal`,`vec3`),m(k),k.constants.add(`tiltThreshold`,`float`,.7),k.code.add(e`vec3 perpendicular(vec3 v) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),f(k),_.include(v),k.main.add(e`
    ...
    }`),A.include(l,g),_.include(C,g),A.include(u),A.uniforms.add(new o(`intrinsicColor`,({color:e})=>e),new n(`tex`,({markerTexture:e})=>e)).constants.add(`texelSize`,`float`,1/64).code.add(e`float markerAlpha(vec2 samplePos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
  ...
  `)),_.include(d,g),_.include(h),A.main.add(e`
    discardBySlice(vpos);
    ...
    outputColorHighlightOLID(finalColor, vpos, finalColor.rgb);`),_}var T=Object.freeze(Object.defineProperty({__proto__:null,build:w},Symbol.toStringTag,{value:`Module`}));export{T as n,w as t};