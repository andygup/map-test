import{Jf as e,Um as t,Wm as n}from"./index-BN8X5Ryz.js";import{n as r,t as i}from"./glsl-BMw-Ib6r.js";import{t as a}from"./Float3PassUniform-SaBA6LBM.js";import{t as o}from"./FloatPassUniform-CSAt82xV.js";import{t as s}from"./FloatBindUniform-CXY5KrrB.js";import{t as c}from"./FloatsPassUniform-DKsLDw29.js";import{t as l}from"./VisualVariables.glsl-1DqsizMu.js";import{n as u,r as d}from"./ScreenSizePerspective.glsl-BuhoSJZ3.js";import{a as f,i as p,t as m}from"./View.glsl-CPcmVaet.js";var h=8;function g(e,s){let{vertex:p,attributes:g}=e;p.uniforms.add(new o(`intrinsicWidth`,e=>e.width));let{hasScreenSizePerspective:v,spherical:y}=s;v?(e.include(u,s),d(p),m(p,s),p.uniforms.add(new f(`inverseViewMatrix`,(e,r)=>t(_,n(_,r.camera.viewMatrix,e.origin)))),p.code.add(r`
...
return size;
    ...
    `)),s.hasVVOpacity?(g.add(`opacityFeatureAttribute`,`float`),p.constants.add(`vvOpacityNumber`,`int`,8),p.uniforms.add(new c(`vvOpacityValues`,h,e=>e.vvOpacity.values),new c(`vvOpacityOpacities`,h,e=>e.vvOpacity.opacityValues),new o(`vvOpacityFallback`,e=>e.vvOpacity.fallback,{supportsNaN:!0})),p.code.add(r`
...
return color;
}`),s.hasVVColor?(e.include(l,s),g.add(`colorFeatureAttribute`,`float`),p.code.add(r`vec4 getColor() {
