import{a as s}from"./chunk-EMFNIAV5.js";import{a as d}from"./chunk-YO4KVV4T.js";import{a as p}from"./chunk-LI2AJFVU.js";import{a as i}from"./chunk-JNLIGAVK.js";import{a as t}from"./chunk-6ZGVESB5.js";import{a as n}from"./chunk-XYMAXA4B.js";import{a as l}from"./chunk-YSASWMAG.js";function c(r){r.code.add(`
  vec4 blendColorsPremultiplied(vec4 source, vec4 dest) {
    float oneMinusSourceAlpha = 1.0 - source.a;
    return source + dest * oneMinusSourceAlpha;
  }
  `)}function A(r,m){let e=r.fragment;e.include(d),r.include(s),e.include(c),e.uniforms.add(new t("globalAlpha",o=>o.globalAlpha),new i("glowColor",o=>o.glowColor),new t("glowWidth",(o,a)=>o.glowWidth*a.camera.pixelRatio),new t("glowFalloff",o=>o.glowFalloff),new i("innerColor",o=>o.innerColor),new t("innerWidth",(o,a)=>o.innerWidth*a.camera.pixelRatio),new p("depthMap",o=>o.depth?.attachment),new n("normalMap",o=>o.normals)),e.code.add(l`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return true;
}`),m.contrastControlEnabled?e.uniforms.add(new n("frameColor",(o,a)=>o.colors),new t("globalAlphaContrastBoost",o=>o.globalAlphaContrastBoost)).code.add(l`float rgbToLuminance(vec3 color) {
