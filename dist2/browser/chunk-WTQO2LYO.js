...
return vec2(1., 0.);
}`),o.constants.add("pathVertexTypeJoin","uint",0),o.uniforms.add(new W("numJoinSubdivisions",n=>n.numJoinSubdivisions)),o.code.add(a`
...
return color;
}`),n?(e.constants.add("vvColorNumber","int",w),e.uniforms.add(new z("vvColorValues",w,i=>i.vvColor.values),new O("vvColorColors",w,i=>i.vvColor.colors),new Y("vvColorFallback",i=>i.vvColor.fallback)),e.code.add(a`
    vec4 getColor() {
...
return normal;
}`)}var Oe=class extends Q{constructor(){super(...arguments),this.numJoinSubdivisions=1,this.size=f(1,1),this.cutoffAngle=0,this.profile=Se.center}};function Ne(r){let t=new q,{vertex:o,fragment:e,varyings:d}=t;Z(o,r),d.add("vpos","vec3",{invariant:!0}),t.include(ze,r);let{output:s,spherical:l,pbrMode:n,snowCover:p,offsetBackfaces:i}=r;switch((K(s)||s===11)&&(t.include(h),t.include(he,r),t.include(X,r),i&&(B(o,r),t.include(se)),d.add("vnormal","vec3"),d.add("vcolor","vec4"),o.main.add(a`
      ...
      vcolor = getColor();
      forwardLinearDepthToReadShadowMap();`)),s){case 0:case 1:case 2:t.include(xe,r),e.include(me,r),e.include(fe,r),t.include(ve,r),e.include(v,r),t.include(ae,r),B(e,r),pe(e),ue(e),e.uniforms.add(o.uniforms.get("localOrigin"),new m("ambient",u=>u.ambient),new m("diffuse",u=>u.diffuse),new x("opacity",u=>u.opacity)),e.include(te),e.include(Ve,r),ce(e),e.main.add(a`
        discardBySlice(vpos);
...
outputObjectAndLayerIdColor();`);break;case 4:t.include(h),t.include(L,r),ee(o),d.add("vnormal","vec3"),o.main.add(a`ExtrudedVertex extrudedVertex = evaluateVertex();
vpos = calculateVPos(extrudedVertex);
...
vpos = calculateVPos(extrudedVertex);
gl_Position = transformPosition(proj, view, vpos);`),t.fragment.include(v,r),t.include(re,r),e.main.add(a`discardBySlice(vpos);
