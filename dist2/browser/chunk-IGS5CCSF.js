import{c as V}from"./chunk-UQ7ZMM5W.js";import{e as O}from"./chunk-VTS3N5X4.js";import{m as h}from"./chunk-VDN3VHDD.js";import{a as b,b as w}from"./chunk-PJJPJV3J.js";import{a as T,b as k,e as R}from"./chunk-SYTOW5CL.js";import{a as F}from"./chunk-SYFPWUTB.js";import{a as v}from"./chunk-JNLIGAVK.js";import{a as z}from"./chunk-6ZGVESB5.js";import{a as l,b as d}from"./chunk-YSASWMAG.js";import{c as m,g as S}from"./chunk-67YVG46W.js";import{f as P,h as M}from"./chunk-DBADRHD4.js";import{d as g}from"./chunk-YMQ4BGWF.js";import{a as y}from"./chunk-JJQR3F6K.js";var W=8;function ce(a,e){let{vertex:t,attributes:r}=a;t.uniforms.add(new z("intrinsicWidth",i=>i.width));let{hasScreenSizePerspective:o,spherical:n}=e;o?(a.include(b,e),w(t),k(t,e),t.uniforms.add(new T("inverseViewMatrix",(i,p)=>P(L,M(L,p.camera.viewMatrix,i.origin)))),t.code.add(l`
...
return size;
    ...
    `)),e.hasVVOpacity?(r.add("opacityFeatureAttribute","float"),t.constants.add("vvOpacityNumber","int",8),t.uniforms.add(new h("vvOpacityValues",W,i=>i.vvOpacity.values),new h("vvOpacityOpacities",W,i=>i.vvOpacity.opacityValues),new z("vvOpacityFallback",i=>i.vvOpacity.fallback,{supportsNaN:!0})),t.code.add(l`
...
return color;
}`),e.hasVVColor?(a.include(O,e),r.add("colorFeatureAttribute","float"),t.code.add(l`vec4 getColor() {
...
return applyOpacity(color);
  ...
  `),e.space===2&&(t.constants.add("maxSegmentLengthFraction","float",.45),t.uniforms.add(new F("perRenderPixelRatio",o=>o.camera.perRenderPixelRatio)),t.code.add(l`
