...
return textureGrad(tex, uvAtlas, dUVdx, dUVdy);
  ...
  `)}var x=class extends f{constructor(t,r,i){super(t,"float",2,(a,n,m)=>a.setUniform1f(t,r(n,m),i))}};var z=1;function le(e,t){if(!v(t.output))return;e.fragment.include(w);let{emissionSource:r,hasEmissiveTextureTransform:i,bindType:a}=t,n=r===3||r===4||r===5;n&&(e.include(L,t),e.fragment.uniforms.add(a===1?new T("texEmission",s=>s.textureEmissive):new U("texEmission",s=>s.textureEmissive)));let m=r===2||n;m&&e.fragment.uniforms.add(a===1?new S("emissiveBaseColor",s=>s.emissiveBaseColor):new l("emissiveBaseColor",s=>s.emissiveBaseColor));let c=r!==0;if(c&&!(r===7||r===6||r===4||r===5)){let s=u=>C(u??0,0,D);e.fragment.uniforms.add(a===1?new h("emissiveStrength",u=>s(u.emissiveStrength)):new x("emissiveStrength",u=>s(u.emissiveStrength)))}let p=r===7,g=r===5,O=r===1||r===6||p;e.fragment.code.add(o`
